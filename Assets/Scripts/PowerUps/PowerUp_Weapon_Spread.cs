...
//Spread weapon type power up script
public class PowerUp_Weapon_Spread : PowerUp
{
    [SerializeField] private WeaponConfig weaponConfigData;  // weapon config data
    PowerUpProperties data;
    Weapon playerWeapon;
    

    private void Awake()  //get necessary gameobject references
    {
    ...
    {
        playerWeapon.SetWeaponType(weaponConfigData, PowerUpTypes.Spread); //Apply weapon power up on player 
        ...
        {  //Weapon type is a temporary powerup so don't disable after pickup
